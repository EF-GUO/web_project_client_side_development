...
export async function fetchSpot() {
    ...
    const list = [
        ...
        images: ['/imgs/IFS_01.jpg','/imgs/IFS_02.jpg','/imgs/IFS_03.jpg','/imgs/IFS_04.jpg'],
        tags: ['地标', '商业区'],
        },
        {
        id: 2,
        ...
        images: ['/imgs/tianfuART_01.jpg','/imgs/tianfuART_02.jpg','/imgs/tianfuART_03.jpg','/imgs/tianfuART_04.jpg','/imgs/tianfuART_05.jpg','/imgs/tianfuART_06.jpg', ],
        tags: ['历史', '文化'],
        },
        {
        id: 3,
        title: '熊猫基地',
        desc: '成都大熊猫繁育研究基地（简称“成都熊猫基地”）成立于 1987 年，是中国乃至世界知名 大熊猫 的迁地保护、科研繁育和科普教育基地。基地模拟熊猫的野外生态环境，拥有竹林、溪流、山丘等景观，是让游客近距离观察大熊猫生活状态、了解大熊猫保护理念的理想场所。',
        address: '四川省成都市成华区熊猫大道 1375 号',
        images: ['/imgs/XMJD_01.jpg', '/imgs/XMJD_02.jpg', '/imgs/XMJD_03.jpg', '/imgs/XMJD_04.jpg'],
        tags: ['文化', '名胜'],
        }
    ]
    return {
